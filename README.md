...
- **`src/services/`**: This is where the magic happens!
  ...
  - **`sf311Functions.ts`**: An _example_ service showing how to build tools. You can replace this.
  - **`sf311.schemas.ts`**: _Example_ Zod schemas for the 311 service.
...
_This is a community boilerplate for the Daemo Engine. Feel free to fork and modify!_

    "daemo-engine": "file:../daemo-engine",
